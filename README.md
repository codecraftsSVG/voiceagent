...
The browser microphone uses Streamlit's native audio recorder. Visitors must grant microphone permission in their browser. The deployment uses `WHISPER_MODEL=tiny` to reduce build time, latency, and memory use on small instances.
